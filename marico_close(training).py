...
data = pd.read_csv('marico_close.csv')
target = 'PredClose'
...
history = model.fit(xtrain,ytrain,verbose=1 ,epochs=15,batch_size=5,validation_data=(xtest,ytest))
...
model.save("marico_close_model.h5")
